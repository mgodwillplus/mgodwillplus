...
(function () {
  ...
  const journal = Array.isArray(CATALOGUE.journal)
    ? CATALOGUE.journal
    : [];
      ...
      <header class="site-nav">
        ...
        <div class="nav-inner">
          ...
          <a
            class="brand"
            href="index.html"
            aria-label="MGodwill+ home"
          >
            <span class="brand-mark">M+</span>

            <span>
              MGODWILL<span class="brand-plus">+</span>
            </span>
          </a>
      ...
      <footer class="site-footer">
        ...
        <div class="footer-main">
          ...
          <div>
            ...
            <p>
              A personal media universe for films,
              music, voices, ideas and stories.
            </p>
        ...
        <div class="footer-bottom">
          ...
          <span>
            © ${new Date().getFullYear()} MGodwill+
          </span>

          <span>
            Created by Godwill Mathenge
          </span>
  ...
  function mediaCard(item, options = {}) {
    ...
    const category =
      item.category || typeLabel(item);

    return `
      <article
        class="media-card${compact}"
          ...
          .map(
            category => `
              <button
                ...
                type="button"
                data-watch-category="${escapeHtml(
                  category
                )}"
              >
                ${escapeHtml(category)}
  ...
  function renderAbout() {
    ...
    if (aboutText) {
      ...
      aboutText.innerHTML = `
        ...
        <p>
          From the work represented here,
          MGodwill+ is being built as a
          personal media universe rather
          than a conventional portfolio.
          Its creator works across video
          and film editing, music and audio,
          podcasts, writing and visual
          storytelling.
        </p>

        <p>
          The platform is designed to gather
          those different creative forms into
          one cinematic experience — with the
          feel of a genuine streaming service
          rather than a collection of
          disconnected links.
        </p>

        <p>
          The project is deliberately being
          developed with free tools and a
          phone-first workflow, while leaving
          room for a considerably larger
  ...
  function renderPlayer() {
    ...
    if (!item) {
      ...
      host.innerHTML = `
        ...
        <div
          class="empty-state player-error"
        >
